...
os.environ["CUDA_VISIBLE_DEVICES"] = "1" # Set the name of GPU that you want to use (0/1)
...
config.gpu_options.per_process_gpu_memory_fraction = 0.6 # Maximum consumption of GPU limit to 0.6 (2 image per gpu)
...
outpath = os.path.join(output_path,video_path[45:]+'_results') 
